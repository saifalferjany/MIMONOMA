...
%WE CALCULATE HOW MUCH JOULIES THE BITS NEED TO ACHIVE A SPECIFIC SE WHERE HIGH SE NEED MORE POWER 
%WITCH MAY WASRED POWER...
%%Noma system
%parameters
N=1e4;
pcir=30;
...
plot(Rtoma,EEOMA,'r-.','LineWidth',1,'DisplayName','EE OMA');
plot(Rtnoma,EENOMA,'b-','LineWidth',1,'DisplayName','EE Noma');
xlim([min(Rtnoma) max(Rtnoma)])
